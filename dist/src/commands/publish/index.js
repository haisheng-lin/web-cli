...
const publish = () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const publisher = getTargetEntry_1.default(pluginName, _constants_1.PLUGIN_PUBLISH_FILENAME);
        const publishOptions = Object.keys((resolvedZoroJSON === null || resolvedZoroJSON === void 0 ? void 0 : resolvedZoroJSON.publish) || {});
        let env = null;
        ...
        if (isFunction(publisher)) {
            publisher(Object.assign(Object.assign({}, _context_1.default), { env, publishOption }));
        }
        else {
            throw new Error(`${pluginName} not implement '${_constants_1.PLUGIN_PUBLISH_FILENAME}' for build command`);
        }
    }
    catch (e) {
        log.error(e.message);
